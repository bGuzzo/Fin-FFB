...
class NYTDataset(Dataset):
    ...
    def __init__(self, split: str = "train"):
        self.ds = load_dataset("bguzzo2k/nyt_100y_news_headlines", split=split, streaming=False)
...
class EDGARDataset(Dataset):
    ...
    def __init__(self, split: str = "train"):
        ...
        self.ds = load_dataset("eloukas/edgar-corpus", "full", split=split, streaming=False)
        self.sections = [f"section_{i}" for i in range(1, 16)]
        # Add sub-sections commonly found
        self.sections.extend(["section_1A", "section_1B", "section_7A", "section_9A", "section_9B"])
